...
public class SimpleTextAnimation extends JPanel{  
    ...
    public void paint(Graphics gp)
    {
        ...
        g2d.drawString("E", 280, d);
       /* g2d.drawString("Y", e, 150); */
        
        g2d.drawString("A", 220, f);
      /*  g2d.drawString("E", g, 200);
        g2d.drawString("W", 280, h); */
        
        g2d.drawString("N", i, 250);
        g2d.drawString("I", 235, j);
        g2d.drawString("C", k, 250);
        g2d.drawString("E", 295, l);
        
        g2d.drawString("D", m, 300);
        g2d.drawString("A", 235, n);
        g2d.drawString("Y", o, 300);
